...
//--------------------------------------------------------------------------------------------------
void LedTest(void) {
	LedRedOn(); DelayMs(62); LedRedOff(); DelayMs(62);
	LedRedOn(); DelayMs(62); LedRedOff(); DelayMs(62);
	LedBlueOn(); DelayMs(62); LedBlueOff(); DelayMs(62);
	LedBlueOn(); DelayMs(62); LedBlueOff(); DelayMs(62);
	LedGreenOn(); DelayMs(62); LedGreenOff(); DelayMs(62);
	LedGreenOn(); DelayMs(62); LedGreenOff(); DelayMs(62);
	LedWhiteOn(); DelayMs(62); LedWhiteOff(); DelayMs(62);
	LedWhiteOn(); DelayMs(62); LedWhiteOff(); DelayMs(62);
}
//--------------------------------------------------------------------------------------------------
void LedTest2(void) {
